    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='https://www.instagram.com/kolejmun/' class='snake-link' style='color:black '>KOLEJMUN instagram</a> ";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "KOLEJMUN Snake<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
